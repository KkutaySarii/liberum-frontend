      ...
      <main className="container max-w-5xl mx-auto mt-12">
        <div className="pt-32 text-center">
          ...
          <p className="text-gray-300 mb-16 text-lg mt-8">
            You must select a blockspace to proceed
          </p>
          <div className="flex items-center justify-center gap-8 mb-16">
            <div className="flex flex-col items-center">
              ...
              <span className="text-white text-2xl mt-3">
                {selectedDomain === null ? (
                  <div className="font-thin text-gray-400">Not selected</div>
                ) : (
            ...
            <div className="flex flex-col items-center ">
              ...
              <button
                className="px-3 py-1 bg-white text-black rounded-md hover:bg-opacity-90 transition-colors text-sm font-semibold mt-3"
          ...
          <div className="flex justify-center gap-8 max-w-xl mx-auto">
            <button
              ...
              onClick={() =>
                selectedDomain &&
                selectedFile &&
                router.push(`/dashboard/link-blockspace`)
              }
