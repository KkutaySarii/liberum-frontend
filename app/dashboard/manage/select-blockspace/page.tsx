                ...
                <div className='pt-32 text-center'> 
                    ...
                    <div className="flex items-center justify-center gap-8 mb-16">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-white text-2xl mt-3">{selectedDomain === null ? <div className='font-thin text-gray-400'>Not selected</div> : <div className='font-normal underline'>{selectedDomain?.name}</div>}</span>
                            ...
                            >
                            {selectedDomain !==null ? 'Change' : 'Select'}
                            </button>
                        ...
                        <div className="flex flex-col items-center ">
                            ...
                            <span className="text-white text-2xl">{selectedFile === null ? <div className='font-thin text-gray-400'>Not selected</div> : <div className='font-normal underline'>{selectedFile?.name}</div>}</span>
