                ...
                <div className='pt-32 text-center'> 
                    ...
                    <div className="flex items-center justify-center gap-8 mb-16">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-white text-2xl mt-3">{selectedBlockspace === null ? <div className='font-thin'>Not selected</div> : <div className='font-normal underline'>{selectedBlockspace.name}</div>}</span>
                            <button 
                        ...
                        <div className="flex flex-col items-center ">
                            ...
                            <span className="text-white text-2xl">{selectedContent === null ? <div className='font-thin'>Not selected</div> : <div className='font-normal underline'>{selectedContent.name}</div>}</span>
