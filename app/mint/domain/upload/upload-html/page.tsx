...
const UploadHtmlPage = () => {
  ...
  const handleFileRead = async (file: File) => {
    ...
    try {
      ...
      if (contract && provider) {
        ...
        const estimateGas = await contract.createPage.estimateGas(
          content,
          file.name
        );
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const tx = await callContractMethod("createPage", htmlContent, fileName);
      ...
      <main className="container max-w-3xl mx-auto mt-12">
        <div className="pt-32 text-center">
          ...
          <div className="max-w-3xl mx-auto mt-6  rounded-2xl overflow-hidden">
            <div
              className={`pb-6 px-6 flex items-stretch justify-between border-b border-white mb-2 ${
            ...
            >
              <div className="flex items-stretch gap-x-4">
                ...
                <div className="flex flex-col h-full justify-around">
                  ...
                  <p className="text-[#A9ACB4] text-start">
